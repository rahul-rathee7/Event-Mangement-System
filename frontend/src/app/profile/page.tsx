...
const Page = () => {
  ...
  return (
    <div>
      ...
      {
        editProfile && (
            <EditProfile seteditProfile={seteditProfile} description={user?.description} location={user?.location}/>
        )
      }
    </div>
  )
